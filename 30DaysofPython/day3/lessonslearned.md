...
3. I also experienced an error while attempting to perform a mathematical caluclation.
        '''
...
5. Some of the solutions worked with for loops that I had previously been familiar with but didn't completely feel comfortable with. For example:
        '''
