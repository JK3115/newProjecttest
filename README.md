...
## Ensured Learning
While AI provided much of the initial code structure, I took an active role in ensuring I truly understood each component by adding detailed comments throughout the project. I didn't want to simply copy code without comprehension—I reused my prior knowledge of Python functions and button structures from building the program and the concepts from my 30 Days of Python journey to shape the UI's look and feel. This hands-on approach meant I still encountered errors even with AI assistance I used AI to debug them and learn how to accompish things like writing user input to a file. I'm proud of this first attempt at bridging command-line logic with a graphical interface, and it reinforced that true learning comes from actively engaging with and troubleshooting code. My goal is still to learn to code, not simply have a machine do it for me, but sometimes I need some help. 