...
def save_credentials():
    ...
    with open("spice_rack.txt", "a", encoding="utf-8") as f:
        # write a simple line with a separator (This utilizes dictionaries as a value type for the list of credentials)
